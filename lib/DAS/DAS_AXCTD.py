...
class AXCTDProcessor(QRunnable):
    ...
    def __init__(self, dll, datasource, vhffreq, tabID, starttime, triggerstatus, firstpointtime, 
        ...
        self.triggerstatus = triggerstatus #0=nothing, 1-3 = 400 Hz pulses, 4=7.5kHz tone
    ...
    def run(self):
        ...
        try:
            ...
            while self.keepgoing:
                ...
                #writing raw data to sigdata file (ASCII) for current thread (TODO: UPDATE FOR AXCTD)
